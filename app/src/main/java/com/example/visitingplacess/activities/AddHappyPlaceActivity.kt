...
import com.example.visitingplacess.utils.GetAddressFromLatLng
...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val mLocationCallBack = object: LocationCallback(){
        override fun onLocationResult(locationResult: LocationResult?) {
            ...
            Log.i("Current Longitue", "$mLongitude")
        ...
        when(p0!!.id){
            ...
            R.id.et_location -> {
                try {
                    ...
                    //start the autocomplete intent with a request code.
            ...
            if(requestCode == GALLERY){
                if(data != null){
                    ...
                    try {
                        ...
                        Log.e("Saved Image Gallery:", "Path:: $saveImageToInternalStorage")
